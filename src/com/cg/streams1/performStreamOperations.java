...
/*class performStreamOperations to perform operations such as even,odd,divisible by 6
* , less than 12 etc using streams method
*/
public class performStreamOperations {
	...
	public static void main(String[] args) {
		...
		// putting 50 Random integers in ArrayList
		for (int i = 1; i <= 50; i++) {
